...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """viewCurrentOrders/""", """controllers.ShoppingCtrl.viewCurrentOrders()"""),
  ...
  // @LINE:26
  private[this] lazy val controllers_ShoppingCtrl_viewCurrentOrders13_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("viewCurrentOrders/")))
  )
  private[this] lazy val controllers_ShoppingCtrl_viewCurrentOrders13_invoker = createInvoker(
    ShoppingCtrl_1.viewCurrentOrders(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.ShoppingCtrl",
      "viewCurrentOrders",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:26
    case controllers_ShoppingCtrl_viewCurrentOrders13_route(params@_) =>
      call { 
        controllers_ShoppingCtrl_viewCurrentOrders13_invoker.call(ShoppingCtrl_1.viewCurrentOrders())
      }
